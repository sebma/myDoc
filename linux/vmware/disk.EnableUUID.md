...
```
Une solution disk.EnableUUID=TRUE dans le vmx OU blacklister le "VMware Virtual disk" dans la conf multipath :  https://bugs.launchpad.net/ubuntu/+source/multipath-tools/+bug/1875594/comments/17 et https://askubuntu.com/a/1340977/426176
